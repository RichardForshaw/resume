...
description: "In Pert 1, we looked at the importance of defining product behaviours. Now we look at how this can actually benefit your AI agents and accelerate development."
tags:
    - agile
...
We have to take the same approach with an AI. Examples of these are:
 ...
 - Define an output. This is important. If you are designing a process flow, ask for a process flow output. If you are discovering behaviours for a tech team, define the output to be testable scenarios (e.g. [Gherkin](https://cucumber.io/docs/gherkin/reference))
